  ...
  render() {
    ...
    return (
      <div className="container-fluid contact-margin-top" id="Contact">
        ...
        {
          idioma === 'en' ? (
            <span className="contact-texto-parrafo texto">&#60;<span><i>&quot;< a href="/es" className="maincolor">{traductor('translate')}</a>&quot;</i></span>&#62;</span>
          ) : (<span className="contact-texto-parrafo texto">&#60;<span><i>&quot;< a href="/en" className="maincolor">{traductor('translate')}</a>&quot;</i></span>&#62;</span>)
        }
